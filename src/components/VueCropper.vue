<template>
  <div class="app-container class-name" :style="containerStyle">
    <img ref="img" :src="src" :alt="alt" :style="imageStyle" :crossorigin="crossorigin">
  </div>
</template>
<script>
import Cropper from '../libs/cropperjs/src/index.js'
